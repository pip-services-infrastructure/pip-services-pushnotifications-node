# Deployment Guide <br/> PushNotifications Microservice
...
```javascript
{
    ...
    "dependencies": {
        ....
        "pip-services-pushnotifications-node": "^1.0.0",
        ...
    }
}
```
...
var plugin = require('pip-services-pushnotifications-node').PushNotificationsSenecaPlugin;
...
or by using [PushNotificationsSenecaClient](https://github.com/pip-services-infrastructure/pip-clients-notification-node/NodeClientApiV1.md/#client_seneca)